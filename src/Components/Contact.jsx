    ...
    return (
        <div>
            ...
            <div className="bg-[var(--purple-bg1)] ">
                ...
                <h1 className='text-center text-4xl font-mono text-[var(--black-color)] pb-7 font-bold'>Contact</h1>
                        ...
                        <div className="lg:w-1/2 lg:mx-6">
                            ...
                            <div className="mt-6 space-y-8 md:mt-8">
                                <p className="flex items-start -mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 textBlue-500 dark:textBlue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                            ...
                            <div className="mt-6 w-80 md:mt-8">
                                ...
                                <div className="flex mt-4 -mx-1.5 ">
                                    <a className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="#">
                                        <svg className="w-10 h-10 fillCurrent" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div
                                ...
                                <form className="mt-6">
                                    ...
                                    <div className="w-full mt-6">
                                        ...
                                        <textarea className="block wFull h-32 px-5 py-3 mt-2 textGray-700 placeholderGray-400 bgWhite border borderGray-200 roundedMd md:h-48 dark:placeholderGray-600 dark:bgGray-900 dark:textGray-300 dark:borderGray-700 focus:borderBlue-400 dark:focus:borderBlue-400 focus:ringBlue-400 focus:outlineNone focus:ring focus:ringOpacity-40" placeholder="Message"></textarea>
                                    </div>
